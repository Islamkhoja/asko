            ...
            <div className="order-head">
              <div className="order-main d-flex align justify">
                <div className='d-flex align'>
                  <h3 className='title-menu'>Отчет без движение
                  </h3>
                </div>
            ...
            <div className='table' >
              <div className='table-head'>
                <ul className='table-head-list d-flex align  justify'>
                  ...
                  <li className='table-head-item w-30'>Day</li>
                            ...
                            <LazyLoad height={65} once>
                              <li key={i} className={`table-body-item`}>
                                <div className='table-item-head d-flex align  justify'>
                                  ...
                                  <div className='w-30 p-16' >
                                    <p className='table-body-text '>
                                      {get(item, 'DocDate') ? (Math.floor((new Date() - new Date(get(item, 'DocDate'))) / (1000 * 60 * 60 * 24))) : '-'}
                                    </p>
                                  </div>
